...
public class DeleteOnCloseTypeDecoder implements DescribedTypeDecoder<DeleteOnClose> {
    ...
    @Override
    public DeleteOnClose readValue(ProtonBuffer buffer, DecoderState state) throws IOException {
    ...
    @Override
    public DeleteOnClose[] readArrayElements(ProtonBuffer buffer, DecoderState state, int count) throws IOException {
        TypeDecoder<?> decoder = state.getDecoder().readNextTypeDecoder(buffer, state);
