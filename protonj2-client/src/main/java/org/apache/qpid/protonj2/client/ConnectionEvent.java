...
public final class ConnectionEvent {
     ...
     * @param failureCause
     *      the failure cause that is associated with this {@link ConnectionEvent}
     */
    public ConnectionEvent(String host, int port, ClientIOException failureCause) {
        this.host = host;
        this.port = port;
     ...
     *
     * @return the failureCause that is associated with this {@link ConnectionEvent}
     */
