 ...
 */
public class WSSConnectionTest extends AMQPerativeTestSupport {
    ...
    private final int DEFAULT_WSS_PORT = 5679;  // ActiveMQ WS can't do dynamic port allocation.
    ...
    public void testCreateConnection() throws Exception {
        ...
        connectOpts.sslOptions().verifyHost(false);
    ...
    protected int getProxyPort() {
        int proxyPort = DEFAULT_WSS_PORT;
