 ...
 */
package org.messaginghub.amqperative.support;
 ...
 */
public class AMQPerativeTestSupport {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(AMQPerativeTestSupport.class);
