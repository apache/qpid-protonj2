 ...
 */
public class ClientPartialMessageException extends ClientException {

    private static final long serialVersionUID = 3354944204399500545L;

    public ClientPartialMessageException(String message) {
        super(message);
    }

    public ClientPartialMessageException(String message, Throwable cause) {
        super(message, cause);
    }
}
