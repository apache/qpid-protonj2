...
import org.apache.qpid.proton4j.engine.test.actions.OpenInjectAction;
import org.apache.qpid.proton4j.engine.test.expectations.OpenExpectation;
...
public class OpenType {
    ...
    public static void injectLater(EngineTestDriver driver, Open open) {
        driver.addScriptedElement(new OpenInjectAction(open, 0));
    }

    public static void injectLater(EngineTestDriver driver, Open open, int channel) {
        driver.addScriptedElement(new OpenInjectAction(open, channel));
    }

    public static void injectNow(EngineTestDriver driver, Open open) {
        driver.sendAMQPFrame(0, open, null);
    }

    public static void injectNow(EngineTestDriver driver, Open open, int channel) {
    ...
    public static class OpenExpectationBuilder implements ExpectationBuilder {
        ...
        @Override
        public OpenResponseBuilder expect(EngineTestDriver driver) {
