...
public class DetachMatcher extends FrameWithNoPayloadMatchingHandler {
    ...
    public DetachMatcher() {
        super(FrameType.AMQP, ANY_CHANNEL, UnsignedLong.valueOf(0x0000000000000016L), Symbol.valueOf("amqp:detach:list"));
    }

    @Override
    public DetachMatcher onCompletion(Runnable onCompletion) {
