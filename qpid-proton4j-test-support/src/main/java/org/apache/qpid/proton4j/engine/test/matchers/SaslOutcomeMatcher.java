...
public class SaslOutcomeMatcher extends FrameWithNoPayloadMatchingHandler {
    ...
    public SaslOutcomeMatcher() {
        super(FrameType.SASL, ANY_CHANNEL, UnsignedLong.valueOf(0x0000000000000044L), Symbol.valueOf("amqp:sasl-outcome:list"));
    }

    @Override
    public SaslOutcomeMatcher onCompletion(Runnable onCompletion) {
