 ...
 *
 * TODO - This type of wrapper is going to be needed for all Netty implementations that use
 *        proton4j.  Consider creating a qpid-proton4j-netty module with support classes just
 *        for netty.
 */
