...
public class ReleasedMatcher extends TypeSafeMatcher<Object> {
    ...
    public void describeTo(Description description) {
        description.appendText("Released which matches: ").appendValue(coreMatcher.getMatchers());
    }
    ...
    public static class ReleasedMatcherCore extends AbstractFieldAndDescriptorMatcher {
        ...
        public ReleasedMatcherCore() {
            super(UnsignedLong.valueOf(0x0000000000000026L), Symbol.valueOf("amqp:released:list"));
        }
