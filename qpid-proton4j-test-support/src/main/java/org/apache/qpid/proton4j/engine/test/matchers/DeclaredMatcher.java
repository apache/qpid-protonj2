...
public class DeclaredMatcher extends TypeSafeMatcher<Object> {
    ...
    public void describeTo(Description description) {
        description.appendText("Declared which matches: ").appendValue(coreMatcher.getMatchers());
    }
    ...
    public static class DeclaredMatcherCore extends AbstractFieldAndDescriptorMatcher {
        ...
        public DeclaredMatcherCore() {
            super(UnsignedLong.valueOf(0x0000000000000033L), Symbol.valueOf("amqp:declared:list"));
        }
