...
public class AcceptedMatcher extends TypeSafeMatcher<Object> {
    ...
    public void describeTo(Description description) {
        description.appendText("Accepted which matches: ").appendValue(coreMatcher.getMatchers());
    }
    ...
    public static class AcceptedMatcherCore extends AbstractFieldAndDescriptorMatcher {
        ...
        public AcceptedMatcherCore() {
            super(UnsignedLong.valueOf(0x0000000000000024L), Symbol.valueOf("amqp:accepted:list"));
        }
