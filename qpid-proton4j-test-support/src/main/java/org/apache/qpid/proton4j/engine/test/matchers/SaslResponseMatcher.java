...
public class SaslResponseMatcher extends FrameWithNoPayloadMatchingHandler {
    ...
    public SaslResponseMatcher() {
        super(FrameType.SASL, ANY_CHANNEL, UnsignedLong.valueOf(0x0000000000000043L), Symbol.valueOf("amqp:sasl-response:list"));
    }

    @Override
    public SaslResponseMatcher onCompletion(Runnable onCompletion) {
