 ...
 */
public class SaslResponseInjectAction implements ScriptedAction {

    private final SaslResponse saslResponse;
    private int channel;

    public SaslResponseInjectAction(SaslResponse saslResponse, int channel) {
        this.saslResponse = saslResponse;
        this.channel = channel;
    }

    public SaslResponseInjectAction onChannel(int channel) {
        this.channel = channel;
        return this;
    }
    ...
    public void perform(AMQPTestDriver driver, Consumer<ProtonBuffer> consumer) {
        driver.sendSaslFrame(channel, saslResponse);
    }
}
