...
public class EndMatcher extends FrameWithNoPayloadMatchingHandler {
    ...
    public EndMatcher() {
        super(FrameType.AMQP, ANY_CHANNEL, UnsignedLong.valueOf(0x0000000000000017L), Symbol.valueOf("amqp:end:list"));
    }

    @Override
    public EndMatcher onCompletion(Runnable onCompletion) {
