...
public interface ScriptedAction extends ScriptedElement {
     ...
     */
    void perform(EngineTestDriver driver, Consumer<ProtonBuffer> consumer);
    ...
    @Override
    default void handleAMQPHeader(AMQPHeader header, EngineTestDriver context) {
        throw new AssertionError("AMQP Header arrived when expecting to perform some action an action");
    }

    @Override
    default void handleSASLHeader(AMQPHeader header, EngineTestDriver context) {
        throw new AssertionError("SASL Header arrived when expecting to perform an action");
    }

    @Override
    default void handleOpen(Open open, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Open arrived when expecting to perform an action");
    }

    @Override
    default void handleBegin(Begin begin, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Begin arrived when expecting to perform an action");
    }

    @Override
    default void handleAttach(Attach attach, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Attach arrived when expecting to perform an action");
    }

    @Override
    default void handleFlow(Flow flow, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Flow arrived when expecting to perform an action");
    }

    @Override
    default void handleTransfer(Transfer transfer, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Transfer arrived when expecting to perform an action");
    }

    @Override
    default void handleDisposition(Disposition disposition, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Disposition arrived when expecting to perform an action");
    }

    @Override
    default void handleDetach(Detach detach, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Detach arrived when expecting to perform an action");
    }

    @Override
    default void handleEnd(End end, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("End arrived when expecting to perform an action");
    }

    @Override
    default void handleClose(Close close, ProtonBuffer payload, int channel, EngineTestDriver context) {
        throw new AssertionError("Close arrived when expecting to perform an action");
    }

    @Override
    default void handleMechanisms(SaslMechanisms saslMechanisms, EngineTestDriver context) {
        throw new AssertionError("SaslMechanisms arrived when expecting to perform an action");
    }

    @Override
    default void handleInit(SaslInit saslInit, EngineTestDriver context) {
        throw new AssertionError("SaslInit arrived when expecting to perform an action");
    }

    @Override
    default void handleChallenge(SaslChallenge saslChallenge, EngineTestDriver context) {
        throw new AssertionError("SaslChallenge arrived when expecting to perform an action");
    }

    @Override
    default void handleResponse(SaslResponse saslResponse, EngineTestDriver context) {
        throw new AssertionError("SaslResponse arrived when expecting to perform an action");
    }

    @Override
    default void handleOutcome(SaslOutcome saslOutcome, EngineTestDriver context) {
