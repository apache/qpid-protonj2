...
public class ModifiedMatcher extends TypeSafeMatcher<Object> {
    ...
    public void describeTo(Description description) {
        description.appendText("Modified which matches: ").appendValue(coreMatcher.getMatchers());
    }
    ...
    public static class ModifiedMatcherCore extends AbstractFieldAndDescriptorMatcher {
         ...
         */
        public enum Field {
            DELIVERY_FAILED, UNDELIVERABLE_HERE, MESSAGE_ANNOTATIONS,
        }

        public ModifiedMatcherCore() {
            super(UnsignedLong.valueOf(0x0000000000000027L), Symbol.valueOf("amqp:modified:list"));
        }
